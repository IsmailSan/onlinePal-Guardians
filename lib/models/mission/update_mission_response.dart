...
class UpdateMissionResponse {
  ...
  factory UpdateMissionResponse.fromMap(Map<String, dynamic> json) {
  ...
  factory UpdateMissionResponse.fromJson(String source) =>
      UpdateMissionResponse.fromMap(json.decode(source));
...
/// helper untuk parsing int yang bisa null
