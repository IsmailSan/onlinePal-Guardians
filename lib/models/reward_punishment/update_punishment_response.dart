...
class UpdatePunishmentResponse {
  final String? status;
  final String? message;
  final RewardMission? data;

  UpdatePunishmentResponse({this.status, this.message, this.data});

  factory UpdatePunishmentResponse.fromJson(Map<String, dynamic> json) =>
      UpdatePunishmentResponse(
  ...
  static UpdatePunishmentResponse fromRawJson(String str) =>
      UpdatePunishmentResponse.fromJson(json.decode(str));
