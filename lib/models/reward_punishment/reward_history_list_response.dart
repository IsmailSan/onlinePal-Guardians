...
class RewardHistoryListResponse {
  ...
  RewardHistoryListResponse({this.status, this.message, this.data});
  ...
  factory RewardHistoryListResponse.fromJson(Map<String, dynamic> json) =>
      RewardHistoryListResponse(
        ...
        data: json['data'] != null
            ? RewardHistoryListData.fromJson(json['data'])
            : null,
      );
...
class RewardHistoryListData {
  ...
  RewardHistoryListData({this.data, this.nextCursor});

  factory RewardHistoryListData.fromJson(Map<String, dynamic> json) =>
      RewardHistoryListData(
        data: json['data'] != null
            ? List<RewardHistoryItem>.from(
