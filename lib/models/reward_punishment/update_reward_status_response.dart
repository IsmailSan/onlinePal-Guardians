...
class UpdateRewardStatusResponse {
  final String status;
  final String message;
  final DeleteReward data;

  UpdateRewardStatusResponse({
    required this.status,
    required this.message,
    required this.data,
  });

  factory UpdateRewardStatusResponse.fromJson(Map<String, dynamic> json) {
    return UpdateRewardStatusResponse(
      status: json['status'],
      message: json['message'],
      data: DeleteReward.fromJson(json['data']),
    );
  }
  ...
  static UpdateRewardStatusResponse fromRawJson(String str) =>
      UpdateRewardStatusResponse.fromJson(json.decode(str));
