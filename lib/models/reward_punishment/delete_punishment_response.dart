...
class DeletePunishmentResponse {
  final String? status;
  final String? message;
  final Punishment? data;

  DeletePunishmentResponse({this.status, this.message, this.data});

  factory DeletePunishmentResponse.fromJson(Map<String, dynamic> json) {
  ...
  static DeletePunishmentResponse fromRawJson(String str) =>
      DeletePunishmentResponse.fromJson(json.decode(str));
