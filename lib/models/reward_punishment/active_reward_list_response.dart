...
class ActiveRewardListResponse {
  ...
  factory ActiveRewardListResponse.fromJson(Map<String, dynamic> json) =>
      ActiveRewardListResponse(
        ...
        data: RewardListData.fromJson(json['data']),
      );
...
class RewardListData {
  ...
  factory RewardListData.fromJson(Map<String, dynamic> json) => RewardListData(
    data: List<RewardItem>.from(
        json['data'].map((x) => RewardItem.fromJson(x))),
...
class RewardItem {
  ...
  factory RewardItem.fromJson(Map<String, dynamic> json) => RewardItem(
    ...
    mission: json['mission'] != null
        ? ActiveMission.fromJson(json['mission'])
        : null,
  );
...
class ActiveMission {
  ...
  factory ActiveMission.fromJson(Map<String, dynamic> json) => ActiveMission(
    id: json['id'],
    name: json['name'],
    description: json['description'],
