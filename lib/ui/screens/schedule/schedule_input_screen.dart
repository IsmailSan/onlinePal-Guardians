...
class ScheduleInputScreen extends StatefulWidget {
  ...
  const ScheduleInputScreen({Key? key, this.isEdit = false, this.scheduleId, this.schedule , this.suggestedSchedule}) : super(key: key);
...
class _ScheduleInputScreenState extends State<ScheduleInputScreen> {
  ...
  void initState() {
    super.initState();
    nameController = TextEditingController(text: widget.schedule?.customName != null ? widget.schedule?.customName : widget.suggestedSchedule ?? '');
                  ...
                  child: BlocListener<ScheduleBloc, ScheduleState>(
                    listener: (context, state) {
                        ...
                        showDialog(
                          ...
                          builder: (_) => SuccessDialog(
                              message: 'Aktivitas berhasil ditambahkan',     onOk: () {
                        ...
                        showDialog(
                          ...
                          barrierDismissible: false,
                          builder: (_) => SuccessDialog(
                              message: 'Aktivitas berhasil diperbarui',     onOk: () {
                            Navigator.pushReplacement(
                              context,
                              MaterialPageRoute(
                                  builder: (context) =>
                    ...
                    child: SizedBox(
                      ...
                      child: OutlinedButton(
                        onPressed: () async {
                          print("${startTime.hour.toString().padLeft(2, '0')}${startTime.minute.toString().padLeft(2, '0')}");
