...
class CreatePunishmentConditionScreen extends StatefulWidget {
  const CreatePunishmentConditionScreen({Key? key}) : super(key: key);

  @override
  State<CreatePunishmentConditionScreen> createState() =>
      _CreatePunishmentConditionScreenState();
}

class _CreatePunishmentConditionScreenState
    extends State<CreatePunishmentConditionScreen> {
