...
class CreateRewardConditionScreen extends StatefulWidget {
  const CreateRewardConditionScreen({Key? key}) : super(key: key);

  @override
  State<CreateRewardConditionScreen> createState() =>
      _CreateRewardConditionScreenState();
}

class _CreateRewardConditionScreenState
    extends State<CreateRewardConditionScreen> {
