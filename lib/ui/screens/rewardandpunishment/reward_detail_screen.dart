            ...
            child: Column(
              ...
              children: [
                Row(
                  ...
                  children: [
                    Text(
                      widget.status == "active" ? "Kondisi Hadiah Aktif" : "Riwayat Hadiah",
                    ...
                    listener: (context, state) {
                      if (state is RewardPunishmentError) {
                        ...
                        showDialog(
                          context: context,
                          barrierDismissible: false,
                          builder: (_) => SuccessDialog(message: 'Kondisi hadiah berhasil dihapus'),
                        );
                      }
                      else if (state is ActiveRewardListLoaded && widget.status == "active") {
                        _isFetchingMore = false;
                        _nextCursor = state.response.data.nextCursor;
                      } else if (state is RewardHistoryListLoaded && widget.status != "active") {
                        _isFetchingMore = false;
                        _nextCursor = state.response.data.nextCursor;
                      }
                    },
                        ...
                        return ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            final int id = isActive
                                ? (reward as RewardItem).id
                                : (reward as RewardHistoryItem).id;
                                    ...
                                    children: [
                                      GestureDetector(
                                          ...
                                          Navigator.push(
                                            ...
                                            MaterialPageRoute(
                                              builder: (context) => EditRewardScreen(
                                                ...
                                                reward: reward as RewardItem, // hanya RewardItem untuk active
                                              ),
                                            ),
                                          );
                                        },
                                        child: Container(
                                          ...
                                          child: Icon(Icons.settings, size: 18.sp, color: Colors.white),
                                        ),
                                      ),
                                      GestureDetector(
                                        onTap: () {
                                          showDialog(
                                            ...
                                            builder: (_) => ConfirmActionDialog<RewardPunishmentBloc>(
                                              title: 'Apakah Anda yakin ingin menghapus kondisi hadiah ini?',
                                              ...
                                              onConfirmEvent: DeleteReward(rewardId: id),
                                            ),
                                          );
                                        },
                                        child: Container(
