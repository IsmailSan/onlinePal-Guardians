...
class MissionPendingConfirmationScreen extends StatefulWidget {
  final Mission? mission;
  const MissionPendingConfirmationScreen({Key? key, this.mission}) : super(key: key);

  @override
  State<MissionPendingConfirmationScreen> createState() =>
      _MissionPendingConfirmationScreenState();
}

class _MissionPendingConfirmationScreenState
    extends State<MissionPendingConfirmationScreen> {

  final typeConditionController = TextEditingController(text: '');
  final specificConditionController
                      ...
                      Center(
                        child: Column(
                          children: [
                            ...
                            OutlinedButton(
                              onPressed: () {
                                Navigator.of(context).pushNamed('/missionEdit', arguments: widget.mission,);
                              },
